...
export class CheckUnsavedDataGuard implements CanDeactivate<AddUsersComponent> {
    ...
    canDeactivate(component: AddUsersComponent, route: ActivatedRouteSnapshot, oldstate: RouterStateSnapshot, newstate: RouterStateSnapshot) {
        return component.isNavigationSafe(newstate.url);
    }
}
